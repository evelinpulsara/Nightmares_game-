...
public class RagdollController : MonoBehaviour
{
    ...
    ParticipantController pcOwner;
    DopplegangerController doppelOwner;
    ...
    void Awake()
    {
        ...
        pcOwner = GetComponentInParent<ParticipantController>();
        doppelOwner = GetComponentInParent<DopplegangerController>();
    }
    ...
    public void SetUp()
    {
        ...
        foreach (Rigidbody bone in playerBones)
        {
            ...
            // Asigna owner según a quién pertenece el ragdoll
            if (pcOwner != null)
                partToCheck.playerOwner = pcOwner;
            if (doppelOwner != null)
                partToCheck.enemyOwner = doppelOwner;
